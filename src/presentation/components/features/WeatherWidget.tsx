...
export default function WeatherWidget({ weather }: WeatherWidgetProps) {
  // Return loading state if weather data is not available
  if (!weather || !weather.current) {
    return (
      <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg shadow-md border border-blue-200 p-6 h-full flex flex-col items-center justify-center">
        <Cloud className="text-blue-300 mb-2" size={48} />
