...
interface TariffAnalysisPanelProps {
  tariff: TariffAnalysis | null;
}

export default function TariffAnalysisPanel({ tariff }: TariffAnalysisPanelProps) {
  // Return loading state if tariff data is not available
  if (!tariff || !tariff.currentRate || !tariff.costBreakdown) {
    return (
      <div className="bg-white rounded-lg shadow-md border border-gray-200 p-6 flex items-center justify-center min-h-[300px]">
        <div className="text-center">
          <DollarSign className="text-gray-300 mx-auto mb-2" size={48} />
