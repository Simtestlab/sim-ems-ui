...
export default function PVMonitoringFilters({ query, location, locations, onQueryChange, onLocationChange, onSearch, onReset }: PVMonitoringFiltersProps) {
